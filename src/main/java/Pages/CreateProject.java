...
public class CreateProject {
	...
	{
		/*
		 * dr.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS); Select dropSt =
		 * new Select(state); dropSt.deselectByVisibleText("Ontario");
		 */
		//state.sendKeys(st);
	...
	{
		/*
		 * dr.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS); Select dropCty =
		 * new Select(city); dropCty.deselectByVisibleText("Toronto");
		 */
		//city.sendKeys(cty);
		boolean b=false;
	...
	{
		/*
		 * Select dropDt = new Select(date); dropDt.selectByVisibleText(dt);
		 */
		Date dat=new Date();
